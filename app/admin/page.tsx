                      ...
                      {companies.map((c) => {
                        ...
                        return (
                          <tr key={c.companyId} className="hover:bg-muted/30 transition-colors">
                            ...
                            <td className="px-4 py-3 text-center">
                              {(() => {
                                const enabled = builderOverrides[c.companyId] ?? c.reportBuilderEnabled
                                return (
                                  <div className="inline-flex items-center gap-1.5">
                                    <Switch
                                      checked={enabled}
                                      onCheckedChange={() => saveLimit(c.companyId, { reportBuilderEnabled: !enabled })}
                                    />
                            ...
                            <td className="px-4 py-3 text-center">
                              {(() => {
                                const enabled = hideZeroOverrides[c.companyId] ?? c.hideZeroRowsEnabled
                                return (
                                  <div className="inline-flex items-center gap-1.5">
                                    <Switch
                                      checked={enabled}
