...
import { RefreshCw, FolderKanban, FileBarChart2 } from "lucide-react"
...
export function WorkspacesPageClient() {
  ...
  async function handleSync() {
    setSyncing(true)
    const toastId = toast.loading("Sincronizando com o Power BI...")
    try {
      ...
      if (warningCount > 0 || inactiveWorkspaceCount > 0 || removedCatalogCount > 0) {
        ...
        toast.success(`${baseMessage}. ${details}.`, { id: toastId })
      } else {
        toast.success(baseMessage, { id: toastId })
      }
            ...
            <CardContent className="flex flex-col items-center gap-4 py-12">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Configure as credenciais do Power BI em Configuracoes e clique em Sincronizar.
                </p>
              </div>
